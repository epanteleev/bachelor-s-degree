...
\begin{frame}{Язык Java}
	\begin{enumerate}
		...
		расширенной возможности обработки исключительных ситуаций. 
	\end{enumerate}
\end{frame}
