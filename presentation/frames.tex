...
\begin{frame}{Возможности для оптимизации}
	\begin{enumerate}
...
\begin{frame}{Цели и задачи}
	Цель: изучить эффективность использования сопрограмм для языка Java.
	\par
	Поставленные задачи:
	\begin{itemize}
...
\begin{frame}{Тесты производительности}
	...
	\begin{itemize}
		\item Скорость создания потока/сопрограммы. % оверхед на создание пропорционален скорости переключения.
