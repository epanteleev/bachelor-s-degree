...
\begin{frame}{Измерение скорости переключения сопрограмм в управляемых средах}
	...
	\begin{table}[H]
		...
		\textit{\begin{tabular}{|c|c|c|c|c|c|}
			...
			\hline \numprint{10000}   & \numprint{1016} $\pm$ 10 & \numprint{1924} $\pm$ 235   & \numprint{8307} $\pm$ 80   \\  
			\hline \numprint{20000}   &              916 $\pm$ 8 & \numprint{1863} $\pm$ 217   & \numprint{7045} $\pm$ 72   \\ 
			\hline \numprint{30000}   &              858 $\pm$ 4 & \numprint{1772} $\pm$ 182   & \numprint{6391} $\pm$ 94   \\ 
			\hline \numprint{40000}   &              790 $\pm$ 8 & \numprint{1606} $\pm$ 194   & \numprint{5790} $\pm$ 67   \\ 
			\hline \numprint{50000}   &              756 $\pm$ 8 & \numprint{1503} $\pm$ 157   & \numprint{5292} $\pm$ 122  \\  
			\hline 
		\end{tabular}}
	\end{table}	
\end{frame}
...
\begin{frame}{Причина худшего результата}
	\begin{itemize}
		\item Причина неэффективного переключения сопрограмм – использование медленных функции для переключения контекста getcontext/setcontext из glibc.
	\end{itemize}
	\begin{table}[H]
		%\caption{Число переключений корутин}\label{inc-matrix}
		\textit{\begin{tabular}{|c|c|c|c|c|c|} 
...
\begin{frame}{Измерение скорости переключения сопрограмм в HuaweiJDK с новыми функциями переключения контекста}
	...
	\begin{table}[H]
		...
		\textit{\begin{tabular}{|c|c|c|c|c|c|}
				\hline \multirow{2}{*}{Шт.} & \multicolumn{3}{|c|}{Число переключений, тыс./сек.}  \\
				\cline{2-4}    		   		& getcontext/setcontext    & Новые функции            & Без +baselineall  \\
				\hline 100     		   		& \numprint{1246} $\pm$ 13 & \numprint{5599} $\pm$ 73 & \numprint{9921} $\pm$ 368 \\
				\hline \numprint{1000} 		& \numprint{1199} $\pm$ 12 & \numprint{5375} $\pm$ 77 & \numprint{9116} $\pm$ 342 \\
				\hline \numprint{5000} 		& \numprint{1075} $\pm$ 59 & \numprint{3510} $\pm$ 75 & \numprint{5535} $\pm$ 268 \\
				\hline \numprint{10000}		& \numprint{1016} $\pm$ 10 & \numprint{3076} $\pm$ 58 & \numprint{4311} $\pm$ 274 \\ 
...
\begin{frame}{Измерение скорости переключения потоков и сопрограмм}
	...
	\begin{table}[H]
		...
		\textit{\begin{tabular}{|c|c|c|c|c|c|}
				...
				\hline \numprint{5000}   & \numprint{3510} $\pm$ 75 & \numprint{1554} $\pm$ 37  \\
				\hline \numprint{10000}  & \numprint{3076} $\pm$ 58 & \numprint{1016} $\pm$ 29  \\ 
				\hline \numprint{20000}  & \numprint{2472} $\pm$ 39 & 753   $\pm$ 28            \\ 
				\hline \numprint{30000}  & \numprint{2106} $\pm$ 38 & 556   $\pm$ 16            \\ 
				\hline \numprint{40000}  & \numprint{1856} $\pm$ 36 & 436   $\pm$ 12            \\ 
				\hline \numprint{50000}  & \numprint{1673} $\pm$ 28 & 361   $\pm$ 8             \\ 
				\hline 
			\end{tabular}
		}
	\end{table}
...
\begin{frame}{Измерение потребление памяти сопрограмм в управляемых средах}
	...
	\begin{table}[H]
		\textit{\begin{tabular}{|c|c|c|c|c|c|}
			...
			\hline 1000    & 23 Mб       & 161 Mб     & 3,105 Mб  \\
			\hline 5000    & 30 Mб       & 187 Mб     & 3,156 Mб  \\
			\hline 10000   & 35 Mб       & 193 Mб     & 3,308 Mб  \\
			\hline 20000   & 40 Mб       & 196 Mб     & 3,320 Mб  \\
			\hline 30000   & 45 Mб       & 197 Mб     & 3,350 Mб  \\
			\hline 40000   & 49 Mб       & 200 Mб     & 3,390 Mб  \\
			\hline 50000   & 55 Mб       & 202 Mб     & 3,407 Mб  \\ 
			\hline 
		\end{tabular}}
	\end{table}
\end{frame}
